...
func fileBucketFromLogFile(pathToLog string) *FileBucket {
	...
	confirm, err := confirmPrompt("With proceeding log file would be deleted. It's already read. But if you will cancel this run, this information will be lost. Do you want to proceed?")
	if err != nil {
...
func populateFileBucket(params *Parameters, fileBucket *FileBucket) {
	files, err := getFilesFromDir(params.InputDir)
	if err != nil {
